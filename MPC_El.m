function out = MPC_El(Reference)
yalmip('clear')

Count2Nm = (15/3276700)*(75/1);
%% MPC speed Controller %%
sysS = load("ElevationSys.mat");
sysSpeed = sysS.sysT6;
...
%% Reference %%
Reference_Position = Reference(3,:)/3600;
Reference_Speed = Reference(4,:)/3600;
...
for i = t0:dt:T
    ...
    yh = [yh, sys.C*xt];
    if i>450
        eh = [eh, (Reference_Position(j)-sys.C(1,:)*xt)^2];
    end
